    ...
    <div>
        <Accordion className={styles.acc}>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography>Job Title | Employee Name<span className={styles.active}>Active</span><span className={styles.active}>HVAC</span><span className={styles.active}>Drywall</span><span className={styles.active}>Demolition</span></Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
